    ...
    <div class="container-fluid">
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body justify-content-between">
          ...
          <li class="nav-item">
              <a href="{{ route('dashboard') }}" class="nav-link mx-2 active">Home</a>
            </li>
  ...
  <section id="courses" class="padding-medium">
    <div class="container">
      <div class="text-center mb-5">
        <h2 class="text-secondary" id="nendoroid">NENDOROID</h2>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/anya.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">NENDOROID SPYxFAM - ANYA FORGER</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/senjuro.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">NENDOROID DS - SENJURO RENGOKU</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/oik.png" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">NENDOROID HAIKYUU - OIKAWA TOORU</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="text-center mb-5">
          <h2 class="text-secondary" id="action">ACTION FIGURE</h2>
        </div>
        <!--ACTION FIGURE-->
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          <!-- <div class="z-1 position-absolute m-4">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/gojo.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">ACT FIGURE JJK - GOJO SATORU</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            ...
            <div class="card-body p-0">
              ...
              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">ACT FIGURE DS -TANJIRO KAMADO</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/zoro1.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">ACT FIGURE ONE PIECE - RORONOA ZORO</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/naruto.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">ACT FIGURE NARUTO SHIPPUDEN - NARUTO UZUMAKI</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="text-center mb-5">
          <h2 class="text-secondary" id="petite">PETITE CHARACTER</h2>
        </div>
        <!--PETITE CHARACTER-->
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          <!-- <div class="z-1 position-absolute m-4">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/kakashi.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">PETITE CHARA NS - KAKASHI HATAKE</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/luke.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">PETITE CHARA TALES SERIES - LUKE FON FABRE</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/sailor-mercury.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">PETITE CHARA SAILOR MOON - SAILOR MERCURY</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/belle.png" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">PETITE CHARA DISNEY - BELLE</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="text-center mb-5">
          <h2 class="text-secondary" id="fluffy">FLUFFY DOLL</h2>
        </div>
        <!--FLUFFY DOLL-->
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          <!-- <div class="z-1 position-absolute m-4">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/dinoo.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">FLUFFY DOLL 01 - NALOONG PLUSH</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/lotso.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">FLUFFY DOLL 02 - LOTSO PLUSH</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/xielian.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">FLUFFY DOLL 03 - XIE LIAN PLUSH</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/pororo.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">FLUFFY DOLL 04 - PORORO</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
    ...
    <div class="text-center mt-4">
      <a href="{{ route('produk') }}" class="btn btn-primary px-5 py-3">TOP</a>
    </div>
