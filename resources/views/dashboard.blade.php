...
<head>
  <title>Allstar - All About Coquette</title>
  <meta charset="utf-8">
...
<body>
  ...
  <nav class="main-menu d-flex navbar navbar-expand-lg p-2 py-3 p-lg-4 py-lg-4 ">
    <div class="container-fluid">
      <div class="main-logo d-lg-none">
        <a href="index.html">
          <img src="{{asset('user')}}/images/allstar.png" alt="logo" class="img-fluid">
        </a>
      </div>
        ...
        <div class="offcanvas-body justify-content-between">
          ...
          <ul class="navbar-nav menu-list list-unstyled align-items-lg-center d-flex gap-md-3 mb-0">
            ...
            <li class="nav-item dropdown">
              <a href="#about" class="nav-link mx-2">About</a></a>
              
            </li>
            <li class="nav-item dropdown">
              <a href="{{ route('produk') }}" class="nav-link mx-2">Product</a></a>
             
            </li>

            <li class="nav-item dropdown">
              <a href="#shop" class="nav-link mx-2">Shop</a></a>
              
            </li>

            <li class="nav-item dropdown">
              <a href="#review" class="nav-link mx-2">Review</a></a>
              
            </li>

            <li class="nav-item dropdown">
              <a href="#blog" class="nav-link mx-2">Blog</a></a>
            </li>

            <li class="nav-item">
              <a href="#kontak" class="nav-link mx-2">Contact</a>
            </li>
            <li class="nav-item">
            <form method="POST" action="{{ route('logout') }}" class="nav-link mx-2">
                    @csrf
  ...
  <section id="home" style="background-image:url({{asset('user')}}/images/satu.png);  ">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 pe-5 mt-5 mt-md-0">
          <h2 class="display-1 text-uppercase">All Your Coquette</h2>
          <p class="fs-4 my-4 pb-2">Find Your Fluffy Stuff!</p>
          <div>
            <form id="form" class="d-flex align-items-center position-relative ">
              <input type="text" name="email" placeholder="looking for something?"
        ...
        <div class="col-md-6 mt-5">
          <img src="{{asset('user')}}/images/melody.png" alt="img" class="img-fluid">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row align-items-center mt-xl-5">
        <div class="offset-md-1 col-md-5">
          <img src="{{asset('user')}}/images/chinaa.jpg" alt="img" class="img-fluid rounded-circle">
        </div>
        <div class="col-md-5 mt-5 mt-md-0">
          ...
          <p>Explore our store's exquisite dolls, where each meticulously crafted creation combines aesthetic beauty
            with timeless charm, offering a captivating array of styles from vintage elegance to whimsical modern
            designs, ensuring that every doll becomes a cherished piece in your collection!.</p>
          <div class="d-flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
              <use href="#tick-circle" class="text-secondary" />
            </svg>
            <p class="ps-4">Meticulous craftsmanship ensuring each doll is a masterpiece.</p>
          </div>
          <div class="d-flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
              <use href="#tick-circle" class="text-secondary" />
            </svg>
            <p class="ps-4">Captivating aesthetic appeal spanning vintage to modern styles.</p>
          </div>
          <div class="d-flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
              <use href="#tick-circle" class="text-secondary" />
            </svg>
            <p class="ps-4">Timeless elegance perfect for collectors and decor enthusiasts alike.</p>
          </div>
          <a href="#about" class="btn btn-primary px-5 py-3 mt-4">Learn more</a>
  ...
  <section id="shop" class="padding-medium">
    <div class="container">
      <div class="text-center mb-5">
        <p class="text-secondary"><b>Some of our most popular online courses</b></p>
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/suguruu.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">NENDOROID JJK - GETO SUGURU</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
                <span class="rating d-flex align-items-center mt-3">
                  <p class="text-muted fw-semibold m-0 me-2">Price: Rp 345.000</p>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/tanjiro.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">ACTION FIGURE - TANJIRO KAMADO</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
                <span class="rating d-flex align-items-center mt-3">
                  <p class="text-muted fw-semibold m-0 me-2">Price: Rp 100.000</p>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/dino.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">FLUFFY DOLL - YELLOW DINOSAURS</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
                <span class="rating d-flex align-items-center mt-3">
                  <p class="text-muted fw-semibold m-0 me-2">Price: Rp 150.000</p>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="{{asset('user')}}/images/sailormoon.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">PETITE FIGURE - SAILOR MOON</p>
                <div class="d-flex align-items-center">
                </div>
              </div>
              <div class="card-text">
                <span class="rating d-flex align-items-center mt-3">
                  <p class="text-muted fw-semibold m-0 me-2">Price: Rp 200.000</p>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          <div class="text-center mt-4">
            <a href="{{ route('produk') }}" class="btn btn-primary px-5 py-3">View all Product</a>
          </div>
        </div>
  </section>

  <section id="review" class="padding-medium bg-primary-subtle">
    <div class="container">
      <div class="text-center mb-4">
        <p class="text-secondary ">looking for something?</p>
        <h2 class="display-6 fw-semibold" id="testimonial">Reviews</h2>
      </div>
      <div class="row">
          ...
          <div class="swiper testimonial-swiper">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide pe-md-5">
                <div class="my-4">
                  <p class="text-muted">“Saya sangat senang dengan kunjungan saya ke Allstar. Mereka memiliki koleksi
                    boneka yang sangat indah dan bervariasi. Saya menemukan boneka vintage yang saya cari-cari dan
                    layanan pelanggan mereka sangat membantu!. ”</p>
                  <div class="row">
                    <div class="col-3"> <img src="{{asset('user')}}/images/reviwer1.jpg" alt="img" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-9">
              ...
              <div class="swiper-slide pe-md-5">
                <div class="my-4">
                  <p class="text-muted">“Toko boneka ini sungguh luar biasa! Saya terkesan dengan keindahan dan
                    detail dari setiap boneka yang mereka tawarkan. Dari gaya klasik hingga modern
                    dapat memikat hati. Saya akan kembali untuk menambah koleksi saya.”</p>
                  <div class="row">
                    <div class="col-3"> <img src="{{asset('user')}}/images/reviwer2.jpg" alt="img" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-9">
              ...
              <div class="swiper-slide pe-md-5">
                <div class="my-4">
                  <p class="text-muted">“Staf yang profesional dan pengetahuan mendalam tentang setiap koleksi membuat
                    nilai tambah dalam pelayanan. Sangat direkomendasikan untuk kolektor dan penggemar boneka!. ”</p>
                  <div class="row">
                    <div class="col-3"> <img src="{{asset('user')}}/images/reviwer3.jpg" alt="img" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-9">
              ...
              <div class="swiper-slide pe-md-5">
                <div class="my-4">
                  <p class="text-muted">“Koleksi yang mengagumkan dengan boneka-boneka unik dan memukau. ”</p>
                  <div class="row">
                    <div class="col-3"> <img src="{{asset('user')}}/images/reviwer1.jpg" alt="img" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-9">
              ...
              <div class="swiper-slide pe-md-5">
                <div class="my-4">
                  <p class="text-muted">“Saya sangat puas dengan pembelian saya di sini. Boneka yang cantik dan
  ...
  <section id="blog" class="padding-medium pt-0">
    <div class="container">
      <div class="text-center">
        <p class="text-secondary "><b>What features we provide</b></p>
      ...
      <div class="row align-items-center mt-5">
        <div class="col-md-6 pe-md-5">
          ...
          <div class="d-flex">
            ...
            <p class="ps-4">Koleksi Terkini dan Beragam: Menyediakan akses mudah ke koleksi terbaru dan beragam boneka,
              termasuk boneka-boneka eksklusif atau edisi terbatas yang sulit ditemukan di tempat lain.
          </div>
          ...
          <div class="d-flex">
            ...
            <p class="ps-4">Pilihan Personalisasi: Menawarkan opsi untuk mempersonalisasi boneka dengan aksesori
              tambahan, pilihan pakaian, atau layanan khusus lainnya sesuai dengan keinginan pelanggan.</p>
          </div>
        ...
        <div class="col-md-6 pe-md-5">
          ...
          <div class="d-flex">
            ...
            <p class="ps-4">Detail Produk Lengkap: Menampilkan deskripsi yang mendetail dan gambar-gambar berkualitas
              tinggi untuk setiap boneka, serta informasi mengenai material, ukuran, dan fitur khusus lainnya.</p>
          </div>
          <div class="d-flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
              <use href="#tick-circle" class="text-secondary" />
            </svg>
            <p class="ps-4">Fitur Pencarian dan Filter: Mempermudah pelanggan dalam menemukan boneka yang mereka cari
              dengan fitur pencarian yang canggih dan filter berdasarkan kategori, harga, atau karakteristik lainnya.
            </p>
          </div>
        </div>
      </div>
  ...
  <section id="register">
    <div class="container padding-medium">
      <div class="row align-items-center">
        <div class="offset-md-1 col-md-5 ">
          <div>
            <h2 class="display-6 fw-semibold">Subscribe and get a limited time, enjoy these special offers on our
              exquisite dolls</h2>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-2 my-3">
          <div class="footer-menu">
            ...
            <ul class="menu-list list-unstyled">
              ...
              <li class="menu-item mb-2">
                <a href="#shop" class="footer-link">Courses</a>
              </li>
              <li class="menu-item mb-2">
                <a href="#blog" class="footer-link">Blogs</a>
              </li>
              <li class="menu-item mb-2">
                <a href="#kontak" class="footer-link">Contact</a>
              </li>
        ...
        <div class="col-sm-6 col-lg-2 my-3">
          ...
          <div class="footer-menu">
            ...
            <ul class="menu-list list-unstyled">
              <li class="menu-item mb-2">
                <a href="#" class="footer-link">allstar@gmail.com</a>
              </li>
              <li class="menu-item mb-2">
                <a href="#" class="footer-link">(0271) 8080 767</a>
              </li>
              <li class="menu-item mb-2">
                <a href="#" class="footer-link">Surakarta, Indonesia</a>
              </li>
            </ul>
          </div>
        </section>
    ...
    <div class="container">
      <div class="row py-3">
        <div class="col-md-6 copyright">
          <p>© 2024 Allstar. All rights reserved.</p>
        </div>
      </div>
    </div>
  </div>
